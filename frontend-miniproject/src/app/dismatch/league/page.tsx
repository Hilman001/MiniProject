<<<<<<< HEAD
"use client"; // <-- Tambahkan ini untuk menandakan bahwa ini adalah client-side rendering
        ...
        {league.length > 0 ? (
          league.map((event) => (
            ...
            >
              ...
              <Image
<<<<<<< HEAD
                src={event.image || "/fallback-image.jpg"} // Fallback image if event.image is not available
=======
                src={event.image}
>>>>>>> 8118a45268e443b64e2558bf8cd9613d7196fe7b
                alt={event.title}
              ...
              <div className="flex items-center gap-3 m-2">
                <Image
<<<<<<< HEAD
                  src={event.organizer?.avatar || "/default-avatar.jpg"} // Fallback avatar if avatar is not available
=======
